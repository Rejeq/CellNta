...
void AlgoSimple::SetDimension(size_t dim)
{
  ...
  //glider2D[1].pos.block(0, 0, 3, 1) = Eigen::Vector3i(posX    , 15, posY + 1);
  //glider2D[2].pos.block(0, 0, 3, 1) = Eigen::Vector3i(posX + 1, 15, posY + 2);
  //glider2D[3].pos.block(0, 0, 3, 1) = Eigen::Vector3i(posX + 1, 15, posY    );
  //glider2D[4].pos.block(0, 0, 3, 1) = Eigen::Vector3i(posX + 2, 15, posY    );
  //SetCell(glider2D);
