...
public:
  ...
  bool Create(const std::string& path);
	...
	bool CreateFromMemory(std::string& srcVertex, std::string& srcFragment, std::string& srcGeometry);
	bool Create(const std::string& pathVertex, const std::string& pathFragment, const std::string& pathGeometry);
#endif
	...
	void Set(const std::string& location, const Eigen::Matrix<float, 2, 2>& value);
	void Set(const std::string& location, const Eigen::Matrix<float, 2, 3>& value);
	void Set(const std::string& location, const Eigen::Matrix<float, 2, 4>& value);

	void Set(const std::string& location, const Eigen::Matrix<float, 3, 3>& value);
	void Set(const std::string& location, const Eigen::Matrix<float, 3, 2>& value);
	void Set(const std::string& location, const Eigen::Matrix<float, 3, 4>& value);

	void Set(const std::string& location, const Eigen::Matrix<float, 4, 4>& value);
	void Set(const std::string& location, const Eigen::Matrix<float, 4, 2>& value);
	void Set(const std::string& location, const Eigen::Matrix<float, 4, 3>& value);
