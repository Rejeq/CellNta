...
function(add_imgui_library)
  ...
  target_sources(ImGui INTERFACE ${TARGET_SOURCES})
  target_include_directories(ImGui INTERFACE ${TARGET_HEADERS})
  target_link_libraries(ImGui INTERFACE ${TARGET_DEPS})
endfunction()
